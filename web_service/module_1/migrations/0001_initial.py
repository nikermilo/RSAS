# Generated by Django 4.2.5 on 2023-11-02 13:36
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        verbose_name="Табельный номер администратора, готовящего заявление",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("Child_Gender", models.TextField(verbose_name="Пол ребёнка")),
                (
                    "Child_Parent_Code",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.RESTRICT,
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.RESTRICT,
                        to="module_1.zav_uvr",
                        verbose_name="Табельный номер заведующего учебно-воспитательной работой, готовящего договор",
                    ),
                ),
            ],
            options={
